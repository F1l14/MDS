...
import leaf_oriented_1D_range_tree as bst
...
start_time_range_tree = time.time()  # Start timer for range tree construction
...
query_range = (min_x, max_x, min_y, max_y, min_z, max_z)  # Adjusted query range format

range_query_result = bst.range_search(min_x, max_x)
unique_range_query_result = list(dict.fromkeys(range_query_result))
...
query_data = [
    ...
    for point in unique_range_query_result
]
