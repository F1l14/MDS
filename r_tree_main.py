...
print(r_tree.root.mbr)

# Calculate the elapsed time for KD-Tree construction
elapsed_time_rtree = end_time_rtree - start_time_rtree
print(f"Time taken for R-Tree construction: {elapsed_time_rtree} seconds.\n")
...
range_query_result = r_tree.search([min_x, max_x, min_y, max_y, min_z, max_z], r_tree.root.members)
...
print(query_elapsed_time)

# Save results
r_tree.saveCSV(range_query_result)
